...
(() => {
  ...
  const scrollAnchorSelectors = [
    ...
    ['projects-header', '#projects .section-header'],
    ['projects-content', '#projects .project-grid'],
    ['projects-card-1', '#projects .project-card:nth-child(1)'],
    ['projects-card-2', '#projects .project-card:nth-child(2)'],
    ['projects-card-3', '#projects .project-card:nth-child(3)'],
    ['projects-card-4', '#projects .project-card:nth-child(4)'],
